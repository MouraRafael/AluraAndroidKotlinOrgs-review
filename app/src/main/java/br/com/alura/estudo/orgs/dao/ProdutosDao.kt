...
class ProdutosDao {
    ...
    companion object {
        private val produtos = mutableListOf<Produto>(
            ...
            Produto("Salada de pera","Laranja, Maçãs e uva", BigDecimal("19.83")),
            Produto("Salada de uva","Laranja, Maçãs e uva", BigDecimal("19.83")),
            Produto("Salada de maça","Laranja, Maçãs e uva", BigDecimal("19.83")),
